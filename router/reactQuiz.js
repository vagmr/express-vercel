...
let quizData = {
    "questions": [
        {
            "question": "哪个是最受欢迎的 JavaScript 框架？",
            "options": ["Angular", "React", "Svelte", "Vue"],
            "correctOption": 1,
            "points": 10
        },
        {
            "question": "哪家公司发明了 React？",
            "options": ["Google", "Apple", "Netflix", "Facebook"],
            "correctOption": 3,
            "points": 10
        },
        {
            "question": "React 应用的基本构建块是什么？",
            "options": ["Components", "Blocks", "Elements", "Effects"],
            "correctOption": 0,
            "points": 10
        },
        {
            "question": "我们用来描述 React 组件中 UI 的语法叫什么名字？",
        ...
        {
            "question": "我们在 React 中直接 \"接触\" DOM 的时候是什么时候？",
            "options": [
                "当我们需要监听一个事件",
                "当我们需要改变 UI",
                "当我们需要添加样式",
...
router.get("/quiz/:id", (req, res) => {
    ...
    const quiz = quizData.find(q => quizData.findIndex(q) === quizId)
    console.log(quiz, quizId, quizData.findIndex(q));
    if (quiz) {
        res.json(
            {
                code: 200,
